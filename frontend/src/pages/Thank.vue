<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Thank you for choosing us to satisfy your hunger!</p>
            <p v-none>
                For a Smoother Process, Please Share a Screenshot of your Order Details via WhatsApp to +91 8092153918
            </p>
            <router-link class="btn" to="/menu">Continue Ordering</router-link>
        </div>
    </div>
</template>
