                ...
                <div class="row">
                                ...
                                <div v-for="(f, index) in filterFoods" :key="index">
                                    <div class="box-content row">
                                        ...
                                        <div class="item-qty col-sm-2 d-inline">
                                            <label for="iQuantity"
                                                style="font-size: 14px; padding-right: 2px;">Quantity:</label>
                                            <input type="number" id="iQuantity" class="form-control item-quantity"
                                                :value="itemQuantity[index]" min="1" max="50"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            <div class="box-title">
                                <h3>Support</h3><br>
                                <h3><i class="fa fa-phone"></i>+91 8092153918</h3>
                                <span>
                                    We are available 24x7. If you have any questions, Talk to us! 
                                </span>
                            </div>
                        </div>
                    </div>
