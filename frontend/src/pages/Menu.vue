            ...
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rPrice" id="rtfPrice" value="1,99" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rtfPrice" class="d-flex justify-content-between">
                                ₹1 - ₹99 <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
                            </label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="99,199" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">
                                ₹99 - ₹199 <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
                            </label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="199" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between"> 
                                ₹199+ <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
                            </label>
                        </li>
                    ...
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="mType" class="d-flex justify-content-between">
                                Non-Veg <button class="unselect-btn" @click="unselectTypeBtn($event)">X</button>
                            </label>
                        </li>
                        ...
                        <li>
                            ...
                            <label for="vType" class="d-flex justify-content-between">
                                Veg <button class="unselect-btn" @click="unselectTypeBtn($event)">X</button>
                            </label>
                        </li>
