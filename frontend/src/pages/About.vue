<template>
    <section class="about-section">
        ...
        <div class="about-content-text">
            <p>Welcome to Handi Biryani Wala, your go-to spot for authentic local cuisine in Muzaffarpur, proudly managed by Mr. Avinash Singh. <br> 
            I) We offer a wide variety of both vegetarian and non-vegetarian dishes, all prepared with fresh and hygienic ingredients. <br>
